...
ActiveRecord::Schema[7.1].define(version: 2024_11_17_212900) do
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.index ["tagged_by_id"], name: "index_tags_on_tagged_by_id"
  ...
  add_foreign_key "tags", "users", column: "tagged_by_id"
